...
class IntercomFormExtension extends DataExtension
{
    ...
    public function sendToIntercom()
    {
        if (empty($this->intercomFieldMapping) &&
            ...
            throw new LogicException('You must define mapped fields to send a form submission to intercom, using ' .
                'Form::setIntercomFieldMapping() or Form::setIntercomNoteMapping()');
        }
